...
const Login = () => {
  ...
  const [loginUser, { error: errorM, data: dataM, loading: loadingM }] = useMutation(LOGIN_USER);
        ...
        case 'login':
          ...
          if (response.data.loginUser) {
            if (response.data.loginUser.status === true) {
              ...
              //Login failure
              setAlertState({ variant: 'danger', message: response.data.loginUser.msg });
          ...
          <div className="row">
            <div className="col-12 col-lg-6">
              {loggedIn ? (
                ...
                <LoginForm formData={formData} btnSettings={btnSettings} handleFrmBtnClick={handleFrmBtnClick} setAlertState={setAlertState} formType='create' validate={false} />
              )}
              <div className="col-12 col-lg-6">
              </div>
            </div>
